...
from models import Student, EmotionLog, AttendanceLog, Incident, Lecture
...
class TestVisionRobustness(unittest.TestCase):
    ...
    def test_pipeline_reconnection(self, mock_vc):
        ...
        # Mock _ensure_yolo_face to avoid network download
        with patch('services.vision_pipeline._ensure_yolo_face', return_value=None):
