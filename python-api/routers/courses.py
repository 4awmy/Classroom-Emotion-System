...
# --- Class CRUD (must be before /{course_id} to avoid route shadowing) ---
...
# --- ClassSchedule CRUD (must be before /{course_id}) ---
...
# --- Enrollment CRUD (must be before /{course_id}) ---
...
# --- Course CRUD (/{course_id} wildcard last) ---
